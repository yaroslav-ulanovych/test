	...
	describe("rendered binding", function() {
		...
		describe("having next always rendered sibling", function() {
			...
			it("rename me", function() {
				var template = $("<div><span id='span1' bt-rendered='rendered1'></span><span id='span2' bt-rendered='rendered2'></span></div>");
				...
				template = $("<div><span id='span1' bt-rendered='rendered1'></span><span id='span2' bt-rendered='rendered2'></span></div>");
